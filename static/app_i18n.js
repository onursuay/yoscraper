...
(function () {
    var DICT = {
        en: {
            ...
            // ── MARKETING ──
            'mkt-nav':             'Marketing',
            'mkt-title':           'Email Marketing',
            'mkt-new-campaign':    'New Campaign',
            'mkt-campaigns':       'Campaigns',
            'mkt-sent-30d':        'Last 30d Sent',
            'mkt-open-rate':       'Open Rate',
            'mkt-active-cmp':      'Active Campaigns',
            'mkt-suppressions':    'Suppressions',
            'mkt-th-name':         'Name',
            'mkt-th-type':         'Type',
            'mkt-th-status':       'Status',
            'mkt-th-created':      'Created',
            'mkt-th-actions':      'Actions',
            'mkt-detail':          'Detail',
            'mkt-launch':          'Launch',
            'mkt-cancel':          'Cancel',
            'mkt-refresh':         'Refresh',
            'mkt-loading':         'Loading...',
            'mkt-back':            '← Marketing',
            'mkt-new-campaign-title': 'New Campaign',
            'mkt-ws-type':         'Type',
            'mkt-ws-segment':      'Segment',
            'mkt-ws-content':      'Content',
            'mkt-ws-schedule':     'Schedule',
            'mkt-ws-type-title':   'Campaign Name & Type',
            'mkt-field-name':      'Campaign Name',
            'mkt-name-ph':         'e.g. March 2025 Tech Campaign',
            'mkt-field-type':      'Campaign Type',
            'mkt-type-bc-desc':    'One-shot email to the selected segment.',
            'mkt-type-seq':        'Sequence (Drip)',
            'mkt-type-seq-desc':   'Automated multi-step email series.',
            'mkt-ws-seg-title':    'Target Segment',
            'mkt-seg-sector':      'Sector',
            'mkt-seg-all-sectors': 'All Sectors',
            'mkt-seg-name':        'Company Name Contains',
            'mkt-seg-from':        'Registration Date From',
            'mkt-seg-to':          'Registration Date To',
            'mkt-seg-match':       'leads match',
            'mkt-ws-cont-title':   'Email Content',
            'mkt-field-subject':   'Subject',
            'mkt-subj-ph':         'Email subject...',
            'mkt-field-body':      'Content (HTML)',
            'mkt-vars':            'Variables:',
            'mkt-ws-steps-title':  'Sequence Steps',
            'mkt-steps-hint':      'Define wait time and email content for each step. Steps are sent in order.',
            'mkt-add-step':        '+ Add Step',
            'mkt-ws-sched-title':  'Send Schedule',
            'mkt-sched-now':       'Send Immediately',
            'mkt-sched-now-sub':   'Emails are queued as soon as the campaign is launched.',
            'mkt-sched-later':     'Scheduled Date/Time',
            'mkt-sched-later-sub': 'Emails are sent at the specified date and time.',
            'mkt-sched-hint':      'For sequence campaigns, the schedule applies to the first step. Subsequent steps wait per their delay setting.',
            'mkt-back-btn':        'Back',
            'mkt-next-btn':        'Next',
            'mkt-ws-preview':      'Preview',
            'mkt-ws-preview-title':'Campaign Preview',
            'mkt-prev-general':    'General Info',
            'mkt-prev-name':       'Campaign Name',
            'mkt-prev-type':       'Type',
            'mkt-prev-segment':    'Segment',
            'mkt-prev-leads':      'Target Leads',
            ...
            'mkt-seg-city':             'City',
            'mkt-cmp-info':        'Campaign Info',
            'mkt-sending-progress':'Sending in progress...',
            'mkt-events':          'Recent Events',
            'mkt-ev-type':         'Event',
            'mkt-ev-email':        'Email',
            'mkt-ev-time':         'Time',
            'mkt-queue':           'Queue Status',
            'mkt-enrollments':     'Enrollments',
